...
describe("Real Data Stress Test", () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        console.log(`✅ Found ${realCustomerIds.length} real customer IDs:`, realCustomerIds.slice(0, 5), "...");
        console.log(`✅ Found ${realReceiverIds.length} real receiver IDs:`, realReceiverIds.slice(0, 5), "...");
    ...
    const createInvoiceWithRealIds = (testIndex) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c;
    ...
    test("Real IDs Test - 3 invoices with real customer/receiver IDs", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            const result = yield createInvoiceWithRealIds(i);
            results.push(result);
            if (result.success) {
        ...
        if (errors.length > 0) {
            console.log(`❌ Errors:`, errors.map((e) => ({
                status: e.status,
    ...
    test("Real IDs Sequential - 5 invoices with real data", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (successful.length > 0) {
            console.log(`🎉 Successfully created invoices:`, successful.map((s) => ({
