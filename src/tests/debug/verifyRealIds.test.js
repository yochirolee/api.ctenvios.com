...
describe("Verify Real Database IDs", () => {
    ...
    test("Check what customer and receiver IDs exist", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        ...
        const yourUser = yield prisma.user.findUnique({
        ...
        // Check rates
        console.log("\n📊 RATES:");
        const rates = yield prisma.rate.findMany({
            select: { id: true, name: true },
            take: 5,
        });
        ...
        if (customers.length > 0 &&
            ...
            const testData = {
                ...
                user_id: yourUser ? yourUser.id : (_a = users[0]) === null || _a === void 0 ? void 0 : _a.id,
                ...
                items: [
                    {
                        ...
                        rate_in_cents: 190,
                        rate_id: ((_b = rates[0]) === null || _b === void 0 ? void 0 : _b.id) || 1,
                        customs_id: 1,
