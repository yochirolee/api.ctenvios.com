...
import { Invoice, Item, PrismaClient, PaymentStatus, InvoiceEventType, InvoiceStatus } from "@prisma/client";
 ...
 */
export function calculatePaymentStatus(paidInCents: number, totalInCents: number): PaymentStatusResult {
