...
const create_agency_schema = zod_1.z.object({
    agency: zod_1.z.object({
        ...
        website: zod_1.z.preprocess((val) => (val === "" || val === null ? undefined : val), zod_1.z.string().url().optional()),
...
const agencies = {
    ...
    create: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!result.success) {
            ...
            throw new app_errors_1.AppError(https_status_codes_1.default.BAD_REQUEST, `Invalid agency data: ${errors}`);
        }
    ...
    getParcelsInAgency: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { rows: parcels_data, total } = yield repositories_1.default.parcels.getInAgency(agencyId, pageNumber, limitNumber);
     ...
     * Body: logo (file)
     */
    uploadLogo: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        const agencyId = Number(id);
        if (isNaN(agencyId) || agencyId <= 0) {
            throw new app_errors_1.AppError(https_status_codes_1.default.BAD_REQUEST, "Invalid agency ID");
        ...
        if (!req.file) {
            throw new app_errors_1.AppError(https_status_codes_1.default.BAD_REQUEST, "No logo file uploaded");
        }
        // Upload to Cloudinary
        const uploadResult = yield upload_service_1.default.uploadAgencyLogo(agencyId, req.file.buffer);
        // Update agency with new logo URL
        const updatedAgency = yield repositories_1.default.agencies.update(agencyId, {
     ...
     * DELETE /:id/logo
     */
    deleteLogo: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { id } = req.params;
        const agencyId = Number(id);
        if (isNaN(agencyId) || agencyId <= 0) {
            throw new app_errors_1.AppError(https_status_codes_1.default.BAD_REQUEST, "Invalid agency ID");
