...
const generate_order_pdf_1 = require("../utils/generate-order-pdf");
const generate_labels_pdf_1 = require("../utils/generate-labels-pdf");
const order_with_relations_1 = require("../types/order-with-relations");
const generate_hbl_pdf_1 = require("../utils/generate-hbl-pdf");
exports.ordersController = {
    ...
    delete: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const orderId = parseInt(id);
            const result = yield repositories_1.default.orders.delete(orderId);
            res.status(200).json(result);
        }
        catch (error) {
            next(error);
