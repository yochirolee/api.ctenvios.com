...
exports.receivers = {
    get: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { rows, total } = yield repositories_1.default.receivers.get(agency_id, parseInt(page) || 1, parseInt(limit) || 50);
    ...
    getByCi: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const flat_receiver = Object.assign(Object.assign({}, receiver), { province: ((_a = receiver.province) === null || _a === void 0 ? void 0 : _a.name) || "", city: ((_b = receiver.city) === null || _b === void 0 ? void 0 : _b.name) || "" });
    ...
    create: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const { first_name, last_name, middle_name, second_last_name, mobile, phone, ci, address, email, province_id, city_id } = req.body;
        const new_receiver = {
