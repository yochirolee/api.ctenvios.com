...
exports.dispatchController = {
    ...
    getAll: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const { dispatches: rows, total } = yield repositories_1.default.dispatch.get(parseInt(page), parseInt(limit), isAdmin ? undefined : user.agency_id, status, payment_status, dispatch_id ? parseInt(dispatch_id) : undefined);
    ...
    finalizeCreate: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const updatedDispatch = yield repositories_1.default.dispatch.completeDispatch(dispatchId, receiverAgencyId, dispatch.sender_agency_id);
