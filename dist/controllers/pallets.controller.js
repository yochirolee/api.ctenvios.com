...
const pallets_pdf_1 = require("../utils/lib-pdf/pallets-pdf");
exports.pallets = {
    /**
    ...
    getReadyForPallet: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const page = Number(req.query.page) || 1;
        const limit = Number(req.query.limit) || 20;
        const result = yield pallets_repository_1.default.getParcelsForPallet(page, limit);
        res.status(200).json({
            rows: result.parcels,
            total: result.total,
            page,
     ...
     */
    generateLabelPdf: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        const { id } = req.params;
        const pallet = yield pallets_repository_1.default.getById(id);
        if (!pallet) {
            throw new app_error_1.default("Pallet not found", 404);
        }
        const parcelsCount = (_c = (_b = (_a = pallet._count) === null || _a === void 0 ? void 0 : _a.parcels) !== null && _b !== void 0 ? _b : pallet.parcels_count) !== null && _c !== void 0 ? _c : 0;
        const totalWeightLbs = Number(pallet.total_weight_kg || 0);
        const pdfBuffer = yield (0, pallets_pdf_1.generatePalletLabelPdf)({
            pallet_id: pallet.id,
            parcels_count: parcelsCount,
            created_at: pallet.created_at,
            total_weight_lbs: totalWeightLbs,
            agency_name: ((_d = pallet.agency) === null || _d === void 0 ? void 0 : _d.name) || "N/A",
            created_by_name: ((_e = pallet.created_by) === null || _e === void 0 ? void 0 : _e.name) || "N/A",
        });
