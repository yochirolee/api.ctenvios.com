...
const financialReports = {
     ...
     */
    getSalesByAgency: (period, agency_id, customStart, customEnd) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const results = yield prisma_client_1.default.order.groupBy({
            by: ["agency_id"],
            where,
            _count: { id: true },
            _sum: {
        ...
        const enrichedResults = yield Promise.all(results.map((r) => __awaiter(void 0, void 0, void 0, function* () {
            const agency = yield prisma_client_1.default.agency.findUnique({
                where: { id: r.agency_id },
                select: { name: true },
            });
            const statusCounts = yield prisma_client_1.default.order.groupBy({
                by: ["payment_status"],
                where: Object.assign(Object.assign({}, where), { agency_id: r.agency_id }),
                _count: { id: true },
            });
            const discounts = yield prisma_client_1.default.discount.aggregate({
                where: {
                    order: Object.assign(Object.assign({}, where), { agency_id: r.agency_id }),
                },
            ...
            return {
                ...
                agency_name: (agency === null || agency === void 0 ? void 0 : agency.name) || "Unknown",
                ...
                orders_paid: statusMap[client_1.PaymentStatus.PAID] || 0,
                orders_pending: statusMap[client_1.PaymentStatus.PENDING] || 0,
                orders_partially_paid: statusMap[client_1.PaymentStatus.PARTIALLY_PAID] || 0,
            };
        })));
     ...
     */
    getSalesByUser: (period, agency_id, customStart, customEnd) => __awaiter(void 0, void 0, void 0, function* () {
        const { start, end } = getDateRange(period, customStart, customEnd);
        const where = {
            created_at: { gte: start, lte: end },
            deleted_at: null, // Exclude soft-deleted orders
        ...
        const enrichedResults = yield Promise.all(results.map((r) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const statusCounts = yield prisma_client_1.default.order.groupBy({
                by: ["payment_status"],
                where: Object.assign(Object.assign({}, where), { user_id: r.user_id }),
                _count: { id: true },
            });
            const statusMap = statusCounts.reduce((acc, s) => {
                acc[s.payment_status] = s._count.id;
            ...
            return {
                ...
                agency_name: ((_a = user === null || user === void 0 ? void 0 : user.agency) === null || _a === void 0 ? void 0 : _a.name) || "Unknown",
                total_orders: r._count.id,
                total_billed_cents: r._sum.total_in_cents || 0,
                total_paid_cents: r._sum.paid_in_cents || 0,
                total_pending_cents: (r._sum.total_in_cents || 0) - (r._sum.paid_in_cents || 0),
     ...
     */
    getPaymentMethodBreakdown: (period, agency_id, customStart, customEnd) => __awaiter(void 0, void 0, void 0, function* () {
        const { start, end } = getDateRange(period, customStart, customEnd);
        const where = {
        ...
        const results = yield prisma_client_1.default.payment.groupBy({
            by: ["method"],
            where,
            _count: { id: true },
            _sum: {
     ...
     * Get customer debts
     */
    getCustomerDebts: (agency_id_1, ...args_1) => __awaiter(void 0, [agency_id_1, ...args_1], void 0, function* (agency_id, limit = 50) {
        const where = {
            payment_status: { in: [client_1.PaymentStatus.PENDING, client_1.PaymentStatus.PARTIALLY_PAID] },
            deleted_at: null, // Exclude soft-deleted orders
        };
        if (agency_id) {
            where.agency_id = agency_id;
        ...
        const enrichedResults = yield Promise.all(results.map((r) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return {
                ...
                customer_phone: (customer === null || customer === void 0 ? void 0 : customer.mobile) || null,
                total_orders: r._count.id,
                total_billed_cents: r._sum.total_in_cents || 0,
                total_paid_cents: r._sum.paid_in_cents || 0,
     ...
     */
    getDailySalesBreakdown: (year, month, agency_id) => __awaiter(void 0, void 0, void 0, function* () {
        const { start, end } = (0, utils_1.getMonthRangeUTC)(year, month);
        const where = {
            created_at: { gte: start, lte: end },
            deleted_at: null, // Exclude soft-deleted orders
        };
        ...
        for (const order of orders) {
            const dateKey = (0, utils_1.formatDateLocal)(order.created_at);
     ...
     */
    getAgencyFinancialSummary: (agency_id, period, customStart, customEnd) => __awaiter(void 0, void 0, void 0, function* () {
        const [salesByAgency] = yield financialReports.getSalesByAgency(period, agency_id, customStart, customEnd);
        const paymentBreakdown = yield financialReports.getPaymentMethodBreakdown(period, agency_id, customStart, customEnd);
        const topUsers = yield financialReports.getSalesByUser(period, agency_id, customStart, customEnd);
        const customerDebts = yield financialReports.getCustomerDebts(agency_id, 20);
        const agency = yield prisma_client_1.default.agency.findUnique({
            where: { id: agency_id },
            select: { name: true },
        });
        return {
            ...
            agency_name: (agency === null || agency === void 0 ? void 0 : agency.name) || "Unknown",
            period,
            total_orders: (salesByAgency === null || salesByAgency === void 0 ? void 0 : salesByAgency.total_orders) || 0,
            total_billed_cents: (salesByAgency === null || salesByAgency === void 0 ? void 0 : salesByAgency.total_billed_cents) || 0,
            total_paid_cents: (salesByAgency === null || salesByAgency === void 0 ? void 0 : salesByAgency.total_paid_cents) || 0,
            total_pending_cents: (salesByAgency === null || salesByAgency === void 0 ? void 0 : salesByAgency.total_pending_cents) || 0,
            total_discounts_cents: (salesByAgency === null || salesByAgency === void 0 ? void 0 : salesByAgency.total_discounts_cents) || 0,
     ...
     */
    getCustomerPendingOrders: (customer_id) => __awaiter(void 0, void 0, void 0, function* () {
        const customer = yield prisma_client_1.default.customer.findUnique({
     ...
     */
    getMonthlyComparison: (agency_id) => __awaiter(void 0, void 0, void 0, function* () {
        const estNow = (0, utils_1.getAdjustedDate)(new Date());
        const currentYear = estNow.getFullYear();
        const currentMonth = estNow.getMonth() + 1; // 1-based month
        const previousMonth = currentMonth === 1 ? 12 : currentMonth - 1;
        const previousYear = currentMonth === 1 ? currentYear - 1 : currentYear;
        const { start: currentMonthStart, end: currentMonthEnd } = (0, utils_1.getMonthRangeUTC)(currentYear, currentMonth);
        const { start: previousMonthStart, end: previousMonthEnd } = (0, utils_1.getMonthRangeUTC)(previousYear, previousMonth);
        const [currentMonthData, previousMonthData] = yield Promise.all([
     ...
     */
    getOrdersDetailedReport: (period_1, agency_id_1, payment_status_1, customStart_1, customEnd_1, ...args_1) => __awaiter(void 0, [period_1, agency_id_1, payment_status_1, customStart_1, customEnd_1, ...args_1], void 0, function* (period, agency_id, payment_status, customStart, customEnd, page = 1, limit = 50) {
        const { start, end } = getDateRange(period, customStart, customEnd);
        const where = {
            created_at: { gte: start, lte: end },
            deleted_at: null, // Exclude soft-deleted orders
        ...
        const detailedOrders = orders.map((order) => {
            ...
            return {
                ...
                receiver: {
                    ...
                    city: ((_a = order.receiver.city) === null || _a === void 0 ? void 0 : _a.name) || null,
                },
                service: {
                    id: order.service.id,
        ...
        const allOrdersForTotals = yield prisma_client_1.default.order.findMany({
            where,
            select: {
                total_in_cents: true,
                paid_in_cents: true,
        ...
        const totals = allOrdersForTotals.reduce((acc, order) => {
            acc.total_orders++;
     ...
     */
    getDailyClosingByUser: (date, agency_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const { start: startOfDay, end: endOfDay } = (0, utils_1.getDayRangeUTC)(date);
        ...
        if (agency_id)
            orderWhere.agency_id = agency_id;
        if (user_id)
            orderWhere.user_id = user_id;
        const ordersToday = yield prisma_client_1.default.order.findMany({
            where: orderWhere,
            orderBy: { created_at: "asc" },
            include: {
        ...
        if (agency_id)
            debtPaymentsWhere.order.agency_id = agency_id;
        if (user_id)
            debtPaymentsWhere.order.user_id = user_id;
        const debtPayments = yield prisma_client_1.default.payment.findMany({
        ...
        for (const [, debtData] of debtOrderMap) {
            ...
            userData.orderRows.push({
                ...
                receiver: {
                    id: order.receiver.id,
                    name: `${order.receiver.first_name} ${order.receiver.last_name}`,
                    city: ((_b = order.receiver.city) === null || _b === void 0 ? void 0 : _b.name) || null,
                },
                service: order.service.name,
                hbl_count: hblCount,
                total_weight_lbs: Math.round(weight * 100) / 100,
        ...
        // Build users array
        const users = [];
        const overallPaymentMap = new Map();
        let totalOrders = 0, totalHbls = 0, totalWeight = 0, totalBilled = 0, totalCollected = 0, totalCharges = 0, totalDiscounts = 0, totalDebtCollections = 0;
        for (const [uId, userData] of userMap) {
            userData.orderRows.sort((a, b) => a.is_debt_collection === b.is_debt_collection ? 0 : a.is_debt_collection ? 1 : -1);
            ...
            users.push({
                ...
                summary: {
                    ...
                    total_pending_cents: userData.stats.totalBilled - userData.stats.totalCollected + userData.stats.debtCollections,
        ...
        const overallPaymentBreakdown = Array.from(overallPaymentMap.entries()).map(([method, stats]) => ({
            method,
        ...
        let agencyInfo;
        if (agency_id) {
            const agency = yield prisma_client_1.default.agency.findUnique({ where: { id: agency_id }, select: { id: true, name: true } });
            if (agency)
                agencyInfo = agency;
        }
        let userInfo;
        ...
        return {
            date: (0, utils_1.formatDateLocal)(date),
     ...
     */
    getDailySalesReport: (date, agency_id, user_id) => __awaiter(void 0, void 0, void 0, function* () {
        const { start: startOfDay, end: endOfDay } = (0, utils_1.getDayRangeUTC)(date);
        ...
        const billingOrders = orders.map((order) => {
            const totalWeight = order.parcels.reduce((sum, p) => sum + Number(p.weight), 0);
            ...
            return {
                ...
                pending_in_cents: order.total_in_cents - order.paid_in_cents,
                payment_status: order.payment_status,
                is_paid: order.payment_status === client_1.PaymentStatus.PAID,
                payment_methods: paymentMethods,
            };
        });
        ...
        let ordersPending = 0;
        let ordersPartial = 0;
        const billingTotals = orders.reduce((acc, order) => {
            acc.total_orders++;
            ...
            if (order.payment_status === client_1.PaymentStatus.PAID)
                ordersPaid++;
            else if (order.payment_status === client_1.PaymentStatus.PARTIALLY_PAID)
                ordersPartial++;
            else if (order.payment_status === client_1.PaymentStatus.PENDING)
                ordersPending++;
            return acc;
        }, {
            total_orders: 0,
        ...
        const payments = yield prisma_client_1.default.payment.findMany({
            where: paymentsWhere,
            orderBy: { date: "asc" },
            include: {
                order: {
        ...
        const collectionsByMethod = new Map();
        ...
        return {
            ...
            billing: {
                ...
                totals: Object.assign(Object.assign({}, billingTotals), { orders_paid: ordersPaid, orders_pending: ordersPending, orders_partially_paid: ordersPartial }),
            },
