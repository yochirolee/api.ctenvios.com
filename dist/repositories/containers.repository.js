    ...
    updateStatus: (id, status, user_id, location, description) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const updated = yield prisma_client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const updatedContainer = yield tx.container.update({
                where: { id },
                data: Object.assign(Object.assign({ status }, (status === client_1.ContainerStatus.DEPARTED && { actual_departure: new Date() })), (status === client_1.ContainerStatus.AT_PORT && { actual_arrival: new Date() })),
            });
            // Create event
            yield tx.containerEvent.create({
                data: {
