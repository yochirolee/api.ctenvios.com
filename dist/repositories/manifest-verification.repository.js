...
const manifestVerification = {
            ...
            if (isExpected) {
                ...
                if (parcel) {
                    const statusDetails = (0, parcel_status_details_1.buildParcelStatusDetails)({
                        ...
                        dispatch_id: (_c = parcel.dispatch_id) !== null && _c !== void 0 ? _c : undefined,
                        container_id: (_d = parcel.container_id) !== null && _d !== void 0 ? _d : undefined,
                        flight_id: (_e = parcel.flight_id) !== null && _e !== void 0 ? _e : undefined,
                        current_warehouse_id: (_f = parcel.current_warehouse_id) !== null && _f !== void 0 ? _f : undefined,
                    });
                    yield tx.parcelEvent.create({
                        data: {
                            parcel_id: parcel.id,
    ...
    reportDamage: (verification_id, tracking_number, user_id, notes) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const discrepancy = yield prisma_client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const statusDetails = (0, parcel_status_details_1.buildParcelStatusDetails)({
                status: parcel.status,
                dispatch_id: (_a = parcel.dispatch_id) !== null && _a !== void 0 ? _a : undefined,
                container_id: (_c = (_b = parcel.container_id) !== null && _b !== void 0 ? _b : verification.container_id) !== null && _c !== void 0 ? _c : undefined,
                flight_id: (_e = (_d = parcel.flight_id) !== null && _d !== void 0 ? _d : verification.flight_id) !== null && _e !== void 0 ? _e : undefined,
                current_warehouse_id: (_f = parcel.current_warehouse_id) !== null && _f !== void 0 ? _f : undefined,
            });
            yield tx.parcelEvent.create({
                data: {
    ...
    resolveDiscrepancy: (discrepancy_id, resolution, user_id) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const updated = yield prisma_client_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (discrepancy.parcel_id) {
                const statusDetails = (0, parcel_status_details_1.buildParcelStatusDetails)({ status: client_1.Status.AT_PORT_OF_ENTRY });
                yield tx.parcelEvent.create({
                    data: {
