...
const receivers = {
    get: (...args_1) => __awaiter(void 0, [...args_1], void 0, function* (page = 1, limit = 10) {
        // Ensure valid numeric values
        const total = yield prisma_client_1.default.receiver.count();
        const rows = yield prisma_client_1.default.receiver.findMany({
            skip: (page - 1) * limit,
            take: limit,
            orderBy: {
                first_name: "asc",
