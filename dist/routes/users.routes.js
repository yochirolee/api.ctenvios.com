...
const updateUserSchema = zod_1.z.object({
    ...
    phone: zod_1.z.string().min(10, "Phone must be at least 10 characters").optional(),
    role: zod_1.z.nativeEnum(client_1.Roles).optional(),
    agency_id: zod_1.z.number().int().positive().optional(),
    carrier_id: zod_1.z.number().int().positive().optional(),
});
 ...
 */
router.post("/", auth_middleware_1.authMiddleware, (0, validate_middleware_1.validate)({ body: createUserSchema }), controllers_1.default.users.create);
...
router.get("/list-user-sessions", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const sessions = yield auth_1.auth.api.listSessions({
        headers: (0, node_1.fromNodeHeaders)(req.headers),
    });
...
router.post("/reset-password", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield auth_1.auth.api.revokeSessions({
        headers: (0, node_1.fromNodeHeaders)(req.headers),
    });
...
router.post("/update", auth_middleware_1.authMiddleware, (0, validate_middleware_1.validate)({ body: updateUserSchema }), controllers_1.default.users.update);
