...
router.get("/deleted", auth_middleware_1.authMiddleware, controllers_1.default.orders.getDeleted);
// GET /orders/:id/parcels - Get parcels by order ID
router.get("/:id/parcels", auth_middleware_1.authMiddleware, controllers_1.default.orders.getParcelsByOrderId);
// GET /orders/:id/status-summary - Get order status summary with parcel breakdown
router.get("/:id/status-summary", auth_middleware_1.authMiddleware, controllers_1.default.orders.getStatusSummary);
...
router.post("/:id/restore", auth_middleware_1.authMiddleware, controllers_1.default.orders.restore);
