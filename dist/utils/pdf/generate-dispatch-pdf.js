...
function generateDispatchPDF(dispatch) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const rowContentY = (rowY) => rowY + rowPaddingVertical;
        ...
        for (const [index, parcel] of dispatch.parcels.entries()) {
            ...
            const descriptionLine = parcelItems.length > 0
                ? parcelItems
            ...
            const productNames = parcelItems
                .filter((item) => { var _a, _b, _c, _d; return (item.unit || ((_b = (_a = item.rate) === null || _a === void 0 ? void 0 : _a.product) === null || _b === void 0 ? void 0 : _b.unit) || "PER_LB") === "FIXED" && ((_d = (_c = item.rate) === null || _c === void 0 ? void 0 : _c.product) === null || _d === void 0 ? void 0 : _d.name); })
                .map((item) => item.rate.product.name);
            const productNameLine = productNames.length > 0
            ...
            const fitsOneLine = productNameLine &&
            ...
            doc.text((0, utils_1.formatCents)(financials.insuranceInCents), seguroX, contentY, { width: seguroWidth, align: "right" });
            const cargoColor = financials.chargeInCents === 0 ? COLORS.MUTED_FOREGROUND : COLORS.FOREGROUND;
            doc.fillColor(cargoColor);
            doc.text((0, utils_1.formatCents)(financials.chargeInCents), cargoX, contentY, { width: cargoWidth, align: "right" });
            const customsColor = financials.customsInCents === 0 ? COLORS.MUTED_FOREGROUND : COLORS.FOREGROUND;
            doc.fillColor(customsColor);
            doc.text((0, utils_1.formatCents)(financials.customsInCents), arancelX, contentY, { width: arancelWidth, align: "right" });
            doc.fillColor(COLORS.FOREGROUND);
            doc.text((0, utils_1.formatCents)(financials.unitRateInCents), precioX, contentY, { width: precioWidth, align: "right" });
            doc.text(`${(0, utils_1.toNumber)(parcel.weight).toFixed(2)}`, pesoX, contentY, { width: pesoWidth, align: "right" });
            doc.font(FONTS.SEMIBOLD).fontSize(7).fillColor(COLORS.FOREGROUND);
            doc.text((0, utils_1.formatCents)(financials.subtotalInCents), subtotalX, contentY, { width: subtotalWidth, align: "right" });
            doc.strokeColor(COLORS.BORDER)
                .lineWidth(0.5)
