...
function generateCleanCTEnviosLabel(doc, order, item, itemIndex, labelWidth, labelHeight) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        currentY += 50;
        //Sender Info
        const senderInfo = (0, capitalize_1.formatName)(order.customer.first_name, order.customer.middle_name, order.customer.last_name, order.customer.second_last_name, 50);
        doc.fontSize(8)
            .font(pdf_fonts_1.FONTS.REGULAR)
