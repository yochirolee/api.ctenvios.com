...
const drawHblSection = (doc, order, item, x, y, width, height) => {
    ...
    cursorY = drawTableRow(doc, x, cursorY, width, 32, [
        ...
        { label: "FORWARDING AGENT", value: forwardingAgent, fontSize: 8, font: pdf_fonts_1.FONTS.MEDIUM },
    ]);
    ...
    cursorY = drawTableRow(doc, x, cursorY, width, 28, [
        ...
        { label: "PORT OF LOADING", value: uppercase(order.agency.name), fontSize: 8, font: pdf_fonts_1.FONTS.MEDIUM },
        {
            label: "PORT OF DISCHARGE",
            value: `${uppercase((_e = order.receiver.province) === null || _e === void 0 ? void 0 : _e.name)} / ${uppercase((_f = order.receiver.city) === null || _f === void 0 ? void 0 : _f.name)}`,
            fontSize: 8,
            font: pdf_fonts_1.FONTS.MEDIUM,
        },
    ]);
...
const drawTableRow = (doc, x, y, width, height, columns) => {
    ...
    columns.forEach((column, index) => {
        ...
        doc.font(pdf_fonts_1.FONTS.MEDIUM)
            .fontSize(7)
            .text(column.label, columnX + 4, y + 4, { width: columnWidth - 8, align: (_a = column.align) !== null && _a !== void 0 ? _a : "left" });
        doc.font((_b = column.font) !== null && _b !== void 0 ? _b : pdf_fonts_1.FONTS.BOLD)
            .fontSize((_c = column.fontSize) !== null && _c !== void 0 ? _c : 10)
            .text(column.value, columnX + 4, y + 14, { width: columnWidth - 8, align: (_d = column.align) !== null && _d !== void 0 ? _d : "left" });
    });
    return y + height;
};
